        ...
        Object.entries(config.breakpoints).forEach(
          ([width, breakpointConfig]) => {
            ...
            if (cleanBreakpointConfig.height) {
              cleanBreakpointConfig.height = String(
                cleanBreakpointConfig.height,
              );
            }
    ...
    <div className="flex-1 flex flex-col min-h-0 bg-background">
            ...
            {!isMobile && (
              <div className="ml-4 flex items-center gap-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    onTotalSlidesChange(parseInt(value))
                  }
                >
                ...
                {currentConfig.pagination && (
                  <span className="text-xs text-muted-foreground">
                    {t("preview.paginationInfo", {
                      dots: Math.ceil(
                        totalSlides / (currentConfig.perPage || 1),
                      ),
                      slides: totalSlides,
      ...
      <div className="flex-1 overflow-y-auto">
        <section className="min-h-full flex items-center justify-center">
          <div className="max-w-6xl mx-auto py-12 w-full px-6">
            <div
              style={{
                  ...
                  <SplideSlide key={index}>
                    <div className="relative h-full">
                      ...
                      <div className="absolute inset-0 bg-black/20 flex items-center justify-center rounded-lg">
                        <span className="text-white text-2xl font-bold bg-black bg-opacity-90 px-4 py-2 rounded">
                          {index + 1}
                        </span>
                      </div>
                    </div>
